...
#. Search for a Kafka instance by specifying filters. You can filter instances by tag, status, name, version, flavor, used/available storage space, maximum partitions, billing mode, and enterprise project. Only enterprise users can filter instances by enterprise projects. :ref:`Table 1 <kafka-ug-180604014__table5086721717534>` describes the various possible statuses of a Kafka instance.
...
#. Modify the following parameters if needed:
   ...
   .. table:: **Table 3** Modifiable Kafka parameters
      ...
      +---------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------+
      | Description               | Click |image5|, enter a new description, and click |image6|.                                                                                        | The modification result is displayed in the upper right corner of the page.                                   |
      |                           |                                                                                                                                                     |                                                                                                               |
      |                           | 0 to 1024 characters.                                                                                                                               |                                                                                                               |
      +---------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------+
      | Enterprise Project        | Click |image7|, select a new enterprise project from the drop-down list, and click |image8|.                                                        | The modification result is displayed in the upper right corner of the page.                                   |
      |                           |                                                                                                                                                     |                                                                                                               |

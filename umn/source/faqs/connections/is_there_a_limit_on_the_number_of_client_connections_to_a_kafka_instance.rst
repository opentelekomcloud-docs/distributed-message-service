...
.. table:: **Table 2** Number of connections of later Kafka instances
   ...
   ======================== ==================================
   kafka.2u4g.cluster.small 2,000
   kafka.2u4g.single.small  2,000
   kafka.2u4g.cluster       2,000
   kafka.2u4g.single        2,000
   kafka.4u8g.cluster       4,000
   kafka.8u16g.cluster      4,000
   kafka.12u24g.cluster     4,000
   kafka.16u32g.cluster     4,000
   ======================== ==================================

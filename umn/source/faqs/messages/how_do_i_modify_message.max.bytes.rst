...
**message.max.bytes** can be modified on the **Parameters** page on the Kafka console. For details, see :ref:`Modifying Kafka Instance Configuration Parameters <kafka-ug-0007>`.

...
:ref:`Table 2 <kafka-specification__table16919145814010>` compares the old and new Kafka instance flavors.

.. _kafka-specification__table16919145814010:

.. table:: **Table 2** Mapping between old and new Kafka instance flavors
   ...
   +------------+--------------------------------+-------------------------------+--------------------------------+
   | 1,200 MB/s | 1,200 MB/s                     | kafka.4u8g.cluster \* 6       | 1,250 MB/s                     |
   +------------+--------------------------------+-------------------------------+--------------------------------+
...
The number of topics is related to the maximum number of partitions allowed (see :ref:`Table 1 <kafka-specification__table152020206204>`) and the specified number of partitions in each topic.

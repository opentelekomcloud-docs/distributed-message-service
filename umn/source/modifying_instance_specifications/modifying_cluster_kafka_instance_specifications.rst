...
#. Specify the storage space, bandwidth, number of brokers, or broker flavor as required.
   ...
   -  Increase the broker quantity\ :ref:` (for later instances) <kafka-ug-181221001__section146651355193212>`.
      ...
      a. For **Change By**, select **Brokers**. Then, enter the number of brokers and click **Next**. The broker quantity range varies by instance specifications. For details, see :ref:`Table 1 <kafka-specification__table152020206204>`.
      b. If public access has been enabled, configure EIPs for the new brokers.
      c. Click **Next**.
      d. Confirm the configurations and click **Submit**.
      ...
      f. After adding brokers, add the IP addresses of the new brokers to the client connection configuration to improve reliability.
